...
import sys
sys.path.append('../')
from rss_reader import get_request, args_parser
import ClassNews
...
class RssReaderTestCase(unittest.TestCase):
    ...
    def check_dicts_to_articles(self):
        self.assertEqual(
